...
<body>
    ...
    <div class="contact-title">
            <h1 style="font-size: 32px; line-height: 10px;">Keni dicka per te shprehur?</h1>
            <h2 style="font-size: 18px;">Dergoni nje koment!</h2>
    </div>
    ...
    <div class="contact">
         ...
         <input name="email" type="email" class="cont" placeholder="Email-i juaj" required><br>
             ...
             <input type="submit" class="form-control-submit" value="DERGO KOMENT" name="dergoni">
